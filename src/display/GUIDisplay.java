...
public class GUIDisplay extends Application implements RefrigeratorDisplay {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        desiredTemp = new Text("Desired Fridge Temp: 30");
        ...
        powerOffButton = new OffButton("Power off");
        powerOnButton = new OnButton("Power on");
        ...
        pane.add(coolingStatus, 2, 1);
        pane.add(desiredTemp, 2, 0);
        pane.add(actualTemperature, 0, 0);
        pane.add(outSideTemp, 1, 0);
        pane.add(lightStatus, 3, 1);
        pane.add(powerStatus, 0, 1);
        pane.add(doorStatus, 1, 1);
        pane.add(doorCloser, 2, 2);
        pane.add(doorOpener, 3, 2);
        pane.add(powerOnButton, 0, 2);
        pane.add(powerOffButton, 1, 2);
        pane.add(externalTemperatureInput, 0, 3);
        pane.add(outsideTempSetter, 1, 3);
        pane.add(desiredTempratureInput, 0, 4);
        pane.add(desiredTempSetter, 1, 4);
